...
export default function CoursesScreen() {
  ...
  // Apply department filter then sort
  ...
  return (
    <ThemedView style={styles.container}>
      <View style={[styles.header, { borderBottomColor: colors.border }]}>
        <ThemedText style={styles.title}>Course Schedule</ThemedText>
        <ThemedText style={[styles.subtitle, { color: colors.lightText }]}>
          Spring Semester 2026
        </ThemedText>
        <ThemedText style={[styles.dateRange, { color: colors.lightText }]}>
          01/26-05/16 • Computer Science & Engineering
        </ThemedText>
        ...
        <View style={styles.controlsRow}>
          ...
          <View style={styles.controlItem}>
            <TouchableOpacity
              ...
              style={[styles.controlButton, { backgroundColor: colors.searchBackground, borderColor: colors.border }]}
            >
              <ThemedText style={styles.controlButtonLabel}>{departmentFilter}</ThemedText>
              <ThemedText style={styles.dropdownArrow}>{showDepartmentDropdown ? '▲' : '▼'}</ThemedText>
            </TouchableOpacity>
          ...
          <View style={styles.controlItem}>
            <TouchableOpacity
              ...
              style={[styles.controlButton, { backgroundColor: colors.searchBackground, borderColor: colors.border }]}
            >
              <ThemedText style={styles.controlButtonLabel} numberOfLines={1}>{getSortLabel(sortBy)}</ThemedText>
            ...
            {showSortDropdown && (
              <View style={[styles.dropdownMenu, { backgroundColor: colors.cardBackground, borderColor: colors.border }]}>
                <ScrollView style={{ maxHeight: 200 }} nestedScrollEnabled>
                  {(['courseCode', 'title', 'instructor', 'credits', 'remaining', 'status'] as SortOption[]).map((option) => (
                    <TouchableOpacity
                      key={option}
